...
if "usuario" in st.session_state:
    ...
    with st.form("novo_paciente"):
        ...
        vaga_concedida = st.radio("Vaga Concedida?", ["Não", "Sim"])
        profissional_responsavel = ""
        horario_atendimento = ""
        data_inicio = ""
        if vaga_concedida == "Sim":
            profissional_responsavel = st.text_input("Profissional Responsável")
            horario_atendimento = st.text_input("Horário de Atendimento")
            data_inicio = st.date_input("Data de Início do Atendimento")
